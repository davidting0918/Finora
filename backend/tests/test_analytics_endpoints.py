...
class TestAnalyticsEndpoints:
    ...
    async def test_get_analytics_overview(
        self, async_client: AsyncClient, session_auth_headers, session_transaction_list
    ):
        """Test getting analytics overview"""
        response_data, status_code = await get_analytics_overview(async_client, session_auth_headers)
    ...
    @pytest.mark.asyncio
    async def test_get_analytics_overview_with_params(
        self, async_client: AsyncClient, session_auth_headers, session_transaction_list
    ):

...
from backend.core.model.analytics import AnalyticsPeriod, AnalyticsQuery
...
async def get_category_breakdown_route(
    ...
    """
    try:
        query = AnalyticsQuery(start_date=start_date, end_date=end_date, transaction_type=transaction_type)
...
async def get_spending_trends_route(
    ...
    """
    try:
        query = AnalyticsQuery(start_date=start_date, end_date=end_date, period=period, category_id=category_id)

"""
Environment configuration and management module for Finora backend.
...
class EnvironmentConfig:
    ...
    def _load_config(self) -> Dict[str, Any]:
        ...
        base_config = {
            ...
            "debug": False,
            "log_level": "INFO",
            "init_sample_transactions": False,
            "init_sample_users": False,
        }
        ...
        env_configs = {
            ...
            Environment.STAGING: {
                ...
                "init_sample_transactions": True,
                "init_sample_users": True,
            },
            Environment.PRODUCTION: {
                "mongo_db_name": os.getenv("MONGO_PROD_DB_NAME"),
                "debug": False,
                "log_level": "INFO",
                "cors_origins": ["https://finora.app", "https://www.finora.app"],
                "init_sample_transactions": False,
                "init_sample_users": False,
            },
        }
